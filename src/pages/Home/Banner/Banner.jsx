...
<div className="text-center my-10 px-4 relative">
  ...
  <div className="bg-white rounded-md p-2">
    <img src="https://i.ibb.co.com/Ky5FpSZ/mi.png" alt="Brand 1" className="h-8 w-20 object-contain" />
  </div>
  <div className="bg-white rounded-md p-2">
    <img src="https://i.ibb.co.com/tbQgGbg/nio.png" alt="Brand 2" className="h-8 w-20 object-contain" />
  </div>
  <div className="bg-white rounded-md p-2">
    <img src="https://i.ibb.co.com/XL0D7Cp/anker-vector-logo.png" alt="Brand 3" className="h-8 w-20 object-contain" />
  </div>
  <div className="bg-white rounded-md p-2">
    <img src="https://i.ibb.co.com/mJ6zxDT/Carro-Logo-1.png" alt="Brand 4" className="h-8 w-20 object-contain" />
  </div>
  <div className="bg-white rounded-md p-2">
    <img src="https://i.ibb.co.com/b3L7hjW/haidiliao.png" alt="Brand 5" className="h-8 w-20 object-contain" />
  </div>
  <div className="bg-white rounded-md p-2">
    <img src="https://i.ibb.co.com/L8cbbVm/advance.png" alt="Brand 6" className="h-8 w-20 object-contain" />
  </div>
</div>
