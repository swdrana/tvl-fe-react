    ...
    <section className="bg-white py-8 px-4 md:px-16 lg:px-24">
      <div className="max-w-6xl flex lg:flex-row flex-col justify-center lg:gap-8 mx-auto lg:items-start text-center">
        <div>
          ...
          {/* CTA Button */}
          <div className="mt-8">
            <button onClick={() => navigate("/contactsales")} className="text-xl font-semibold rounded-full bg-gradient-to-r hover:bg-gradient-hover px-4 py-2 text-white h-12 w-44">
              Book a demo
            </button>
          </div>
        </div>
